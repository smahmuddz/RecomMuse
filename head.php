...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fd3c4f;" >
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/wave.png" alt="logo" width="50px" srcset=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" style="color:#ffffff;" aria-current="page" href="album.php">Albums</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" style="color:#ffffff;" aria-current="page" href="artists.php">Artists</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" style="color:#ffffff;" aria-current="page" href="feed.php">Discover</a>
        </li>
      ...
      <form class="d-flex" role="search">
        <?php if(empty($_SESSION['login'])):?>
          <a href="login.php" class="btn btn-light mx-4" type="button">Login</a>
        <?php endif; ?>
