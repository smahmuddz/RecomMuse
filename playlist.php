...
<body>
    <div class="container mt-5">
        <h3 class="mb-2" style="color:red;">ইউজার প্লেলিস্ট</h3>
        <p>ইউজার এর লাইক করা গান নিয়ে বানানো প্লেলিস্ট।</p>
        <?php
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            // Fetch liked songs by the current user
            $query = "SELECT songs.id, songs.name, songs.music, songs.coverImage FROM songs
                      INNER JOIN liked_songs ON songs.id = liked_songs.song_id
                      WHERE liked_songs.user_id = $user_id AND liked_songs.liked = 1
            ...
            echo "<p style='color:red;'>ইউজার লগিন করা নেই।</p>";
        }
        ?>
        ...
        <div class="music-player">
            ...
            <div class="player-main">
                ...
                <?php } else { ?>
                    <div class="main-current">
                        <p>কোন পছন্দের গান পাওয়া যায় নি.</p>
                    </div>
                <?php } ?>
